...
class EnvironmentBuilder:
    ...
    def build_solar_system(self):
        sun     = CelestialBody("Sun",     "#FFBB00", 0, 0, 0, 0, 1.98841e+30, 695700000)
        earth   = CelestialBody("Earth",   "#0000FF", 8.8849199103e+10, -1.231946260580683e+11, 2.367935234360274e+04, 1.732460771717754e+04, 5.972e+24, 6371000)
        moon    = CelestialBody("Moon",    "#FFFFFF", 8.845458567677164e+10, -1.231718062514402e+11, 2.357516641748786e+04, 1.634046499224200e+04, 7.34767309e+22, 1737530)
        ...
        halley = CelestialBody("Halley",   "#B11489", )
        self.objects.extend([sun, earth, moon, mercury, venus, mars, jupiter, saturn, uranus, neptune, pluto])
